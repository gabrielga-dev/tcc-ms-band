package br.com.events.band.older.infrastructure.process.sheetMusic.delete;
...
public interface DeleteSheetMusicValidation extends BaseVoidReturnProcess<DeleteSheetMusicUseCaseForm> {
}
