...
public final class UpdateBandMapper {
    ...
    public static UpdateBandProcessDTO toValidatorDto(BandTable entity, UpdateBandUseCaseForm form) {
    ...
    public static void transferData(BandTable toUpdate, UpdateBandUseCaseForm data) {
