...
/**
 * Tests for {@link ActivateMusicUseCaseImpl}
 *
 * @author gabriel
 */
@ExtendWith(MockitoExtension.class)
class ActivateMusicUseCaseImplTest {
    ...
    @InjectMocks
    private ActivateMusicUseCaseImpl useCase;
    ...
    void executeWhenMusicIsNotFoundThenThrowsMusicNonExistenceException() {
        ...
        verify(findMusicCommand, atMostOnce()).byUuid(MockConstants.STRING);
    ...
    @Test
    @DisplayName("execute - when person is band owner, then activate music")
    void executeWhenPersonIsBandOwnerThenActivateMusic() {
        var musicFound = MusicTableMock.build();
        musicFound.setActive(false);
        ...
        Assertions.assertTrue(musicFound.isActive());
